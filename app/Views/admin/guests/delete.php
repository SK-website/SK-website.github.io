    ...
    <div class="card-body">
      <form method="POST" class="form-horizontal">
        <div class="form-group">
          <label for="name"><?=$guests->username?></label>
          
          <small id="nameHelp" class="form-text text-muted"><h2>This Guest will be deleted! Are You Sure?</h2></small>
        </div>
                
        <div class="form-group">
            <button type="submit" name="submit" class="btn btn-danger">Delete Guest</button>
